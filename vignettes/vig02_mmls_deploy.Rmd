...
In addition to the above features, ML Server includes comprehensive facilities to manage a server pool, authenticate users, and do load balancing. For the purposes of this vignette, we'll let Kubernetes handle these issues. More information can be obtained from the [relevant pages on docs.microsoft.com](https://docs.microsoft.com/en-us/machine-learning-server/operationalize/how-to-deploy-web-service-publish-manage-in-r).
...
# make sure you use a strong password in a production setting
...
#> bos-rf-svc   LoadBalancer   10.0.107.147   52.187.245.39   8000:30365/TCP   5m 
