...
#'
#' - `config`: The file used to store the cluster configuration details. By default, this will be located in the R temporary directory. To use the Kubernetes default ~/.kube/config file, set this argument to NULL. Note that any existing file in the given location will be overwritten.
#' - `role`: This can be `"User"` or `"Admin`", with the default being the former.
#'
#' @seealso
